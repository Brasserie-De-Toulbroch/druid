...
DruidVolume::DruidVolume()
{
    ...
    connect( _compute_sterilizer, &QPushButton::clicked, this, &DruidVolume::compute_sterilizer );
    connect( _compute_boiler, &QPushButton::clicked, this, &DruidVolume::compute_boiler );
    connect( _compute_fermentor, &QPushButton::clicked, this, &DruidVolume::compute_fermentor );
}
...
float DruidVolume::volume_in_l( const Tun &tun, const float height_from_top ) const
{
